...
Important In order to retain the geospatial properties, the left data frame must the sf data.frame (i.e. hunan)
...
Important: for low-low/high-high comparisons, use median if data is highly skewed.
...
Warning For p-values, the appropriate classification should be 0.001, 0.01, 0.05 and not significant instead of using default classification scheme.
