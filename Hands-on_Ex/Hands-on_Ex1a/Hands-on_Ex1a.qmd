...
Notice that only the first ten records will be displayed. Do you know why? Ans: By default, RStudio and some other environments may display a summary or a subset of the data when printing large objects to the console. This is often done to save space and improve readability.
...
Depending on the classification used, the color intensity and range can be different for each classification.

> DIY: Preparing choropleth maps by using similar classification method but with different numbers of classes (i.e. 2, 6, 10, 20). Compare the output maps, what observation can you draw?

Depending on the granularity (i.e. no of classes) the certain regions may show differing shades as compared to prior.
...
tm_shape(mpsz_pop2020)+ 
  tm_fill("DEPENDENCY",n = 6,style = "jenks") +
  tm_borders(alpha = 0.5)
