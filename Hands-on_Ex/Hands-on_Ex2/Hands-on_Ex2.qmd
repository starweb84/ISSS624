...
In this hands-on exercise, I will learn how to compute spatial weights using R. By the end to this hands-on exercise, you will be able to:
...
5.3 Visualising contiguity weights A connectivity graph takes a point and displays a line to each neighboring point. We are working with polygons at the moment, so we will need to get points in order to make our connectivity graphs. The most typically method for this will be polygon centroids. We will calculate these in the sf package before moving onto the graphs. Getting Latitude and Longitude of Polygon Centroids
...
Quiz: What is the meaning of "Average number of links: 3.681818" shown above? Ans: the "Average number of links" refers to the average number of neighboring regions for each region in the dataset. Specifically, it represents the average connectivity or spatial relationships between regions in a spatial weights matrix.
...
In this section, I will learn how to derive a spatial weight matrix based on Inversed Distance method.
...
Question: Can you see the meaning of Spatial lag with row-standardized weights now? Ans: The meaning of spatial lag with row-standardized weights is tied to understanding how the values of a variable in a particular location are related to the average or weighted average values of the same variable in neighboring locations, with the weights reflecting the spatial relationships between locations. In practical terms: - If the spatial lag variable is high for a specific location, it suggests that the values of the variable at that location are similar to the average values of the variable in its neighboring locations. - If the spatial lag variable is low, it suggests that the values of the variable at that location are dissimilar to the average values in its neighborhood.
...
Question: Can you understand the meaning of Spatial lag as a sum of neighboring values now? Ans: When we say "as a sum of neighboring values," it means that the spatial lag is computed by adding up the values of the variable in all the neighboring locations. Neighboring locations are typically defined by a spatial relationship or adjacency criteria, such as sharing a border, being within a certain distance, or belonging to the same administrative unit.
